...
robot_rois = {
    # 'robot1': [
    #     {'min_x': 0.0, 'min_y': 0.0, 'max_x': 2.0, 'max_y': -2.0},
    #     {'min_x': 2.0, 'min_y': -4.0, 'max_x': 4.0, 'max_y': -2.0}
    #     # 您可以为 robot1 添加更多 ROI，或为其他 robot 添加列表
    # ],
    'robot2': [
        {'min_x': 0.0, 'min_y': 0.0, 'max_x': 2.0, 'max_y': 2.0},
        {'min_x': 2.0, 'min_y': 2.0, 'max_x': 4.0, 'max_y': 4.0}
    ],
    # 'robot3': [
    #     {'min_x': -4.0, 'min_y': 0.0, 'max_x': -2.0, 'max_y': 2.0},
    #     {'min_x': -4.0, 'min_y': 2.0, 'max_x': -2.0, 'max_y': 4.0}
